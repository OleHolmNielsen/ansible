...
wikis = [
    ...
    ("it",  r"^https://rsnap2\.fysik\.dtu\.dk/it.*$"),
    ("fyswiki",  r"^https://fyswiki\.fysik\.dtu\.dk/fyswiki.*$"),
    # ("it",  r"^https://intrawiki\.fysik\.dtu\.dk/it.*$"),
    ("HEFatS",  r"^https://rsnap2\.fysik\.dtu\.dk/HEFatS.*$"),
]
...
class FarmConfig(multiconfig.DefaultConfig):
    ...
    # acl_rights_before = u"OleHolmNielsen:read,write,delete,revert,admin"
    ...
    DesktopEdition = False # make sure desktop edition is turned off
    ...
    # mail_smarthost = "mail.fysik.dtu.dk"
    mail_smarthost = "smtp.ait.dtu.dk"

    # The return address, e.g u"Jürgen Wiki <noreply@mywiki.org>" [Unicode]
    mail_from = u"noreply@fysik.dtu.dk"
